...
extension ShortcutAction {
    ...
    public var defaultStroke: ShortcutStroke? {
        ...
        case .resizePaneLeft: return ShortcutStroke(key: "←", command: true, control: true)
        case .resizePaneRight: return ShortcutStroke(key: "→", command: true, control: true)
        case .resizePaneUp: return ShortcutStroke(key: "↑", command: true, control: true)
        case .resizePaneDown: return ShortcutStroke(key: "↓", command: true, control: true)
